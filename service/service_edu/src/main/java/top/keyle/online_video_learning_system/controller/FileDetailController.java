...
public class FileDetailController {
     ...
     */
    @PostMapping("/upload")
    @ApiOperation(value = "文件上传",notes = "上传文件，成功返回文件 url")
    ...
    @ApiOperation(value = "上传简略图",notes = "上传图片裁剪大小并生成一张缩略图，成功返回文件信息")
    ...
    @ApiOperation(value = "上传文件到指定存储平台",notes = "上传文件到指定存储平台，成功返回文件信息")
    ...
    @ApiOperation(value = "监听下载进度并下载图片",notes = "监听下载进度并下载图片")
     ...
     * @param url
     */
    @ApiOperation(value = "删除文件",notes = "根据url删除指定文件")
